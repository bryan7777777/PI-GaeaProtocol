function configurarSelecaoPersonagem() {
  const personagensInfo = {
    ...
    agatha: {
      ...
      dificuldade: "🎵NÍVEL DE DIFICULDADE: ☠️☠️☠️☠️☠️🎵",
      cor: "rgb(141, 7, 231)",
      descricao: "Agatha é uma médica brilhante, utiliza de suas abilidades medicas e musicais para lutar, seu deck é focado em cartas musicais e ela possui uma mecanica de notas, ela também possui uma carta especial unica.",
      cardFoco: "Deck focado em cartas musicais, com mecanica de notas, onde sua abilidade define sua jogada.",
      hp: 60,
      maxHp: 60,
      energia: 4,
      escudo: 0,
